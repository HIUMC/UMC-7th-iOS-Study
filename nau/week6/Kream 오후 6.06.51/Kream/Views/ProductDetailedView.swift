...
class ProductDetailedView: UIView {
    ...
    public lazy var backBtn = UIButton().then {
        $0.setImage(UIImage(named: "icon_arrow_back.png"), for: .normal)
    }
    ...
    lazy var text3 = UILabel().then {
        $0.text = "Matin Kim Logo Coating Jumper"
        $0.font = UIFont.systemFont(ofSize: 16, weight: .regular)
        $0.textColor = .black
    }
    
    lazy var text4 = UILabel().then {
        $0.text = "마뗑킴 로고 코팅 점퍼 블랙"
        $0.font = UIFont.systemFont(ofSize: 12, weight: .regular)
        $0.textColor = UIColor(hue: 0, saturation: 0, brightness: 0.61, alpha: 1.0)
    }
    ...
    private func setupView() {
        ...
        CustomtabBar.addSubview(savedBtn)
        ...
        purchaseBtn.snp.makeConstraints{
            ...
            $0.left.equalTo(savedBtn.snp.right).offset(19)
            $0.width.equalTo(147)
            $0.height.equalTo(49)
        }
...
class CustomButton: UIButton {
    ...
    private func setupView() {
        ...
        subtitleText.snp.makeConstraints{
            $0.top.equalTo(self).inset(8)
            $0.left.equalTo(self).inset(59)
        }
