...
class basicButton: UIButton {
    init(image: UIImage?, color: UIColor = .black){
        super.init(frame: .zero)
...
class MYView: UIView {
    ...
    private lazy var setButton = basicButton(image: UIImage(imageLiteralResourceName: "환경 설정 버튼"))
    //설정버튼
    
    private lazy var cameraButton = basicButton(image: UIImage(imageLiteralResourceName: "Vector-4"))
    //카메라버튼
