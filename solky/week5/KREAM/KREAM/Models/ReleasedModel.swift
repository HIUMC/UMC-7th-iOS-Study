...
extension ReleasedModel {
    static func dummy2() -> [ReleasedModel] {
        return [
            ...
            ReleasedModel(image: "yellowshoes.png", volumename: "거래 15.6만", savedimage: "_icon_saved_filled.png", brandname: "Jordan", productname: "Jordan 1 Retro High OG \n Yellow Ochre", pricename: "228,000원", rightbuyname: "즉시 구매가"),
            ReleasedModel(image: "jumper.png", volumename: "거래 12.8만", savedimage: "_icon_saved_none.png", brandname: "Human Made", productname: "Human Made x Kaws \n Varsity Jacket #1 Black", pricename: "2,000,000원", rightbuyname: "즉시 구매가")
        ]
    }
}
