...
extension ReleasedModel {
    static func dummy2() -> [ReleasedModel] {
        return [
            ...
            ReleasedModel(image: "matinkim.png", volumename: "거래 12.8만", savedimage: "_icon_saved_filled.png", brandname: "Matin Kim", productname: "Matin Kim Logo Coating Jumper", pricename: "228,000원", rightbuyname: "즉시 구매가")
        ]
    }
}
